...
Game.EntityMixins.TaskActor = {
  ...
  hunt: function() {
    ...
    var source = this;
    var z = source.getZ();
    var path = new ROT.Path.AStar(player.getX(), player.getY(), function(x,
      y) {
...
Game.EntityMixins.GiantZombieActor = Game.extend(Game.EntityMixins.TaskActor, {
  ...
  spawnSlime: function() {
    ...
    if (!this.getMap().isEmptyFloor(this.getX() + xOffset, this.getY() +
        yOffset,
        this.getZ())) {
...
Game.EntityMixins.Attacker = {
  ...
  attack: function(target) {
    ...
    if (target.hasMixin('Destructible')) {
      ...
      Game.sendMessage(this, 'YOU STRIKE THE %s FOR %d DAMAGE!', [target.getName(),
        damage
      ]);
      Game.sendMessage(target, 'THE %s STRIKES YOU FOR %d DAMAGE!', [this.getName(),
        damage
      ]);
...
Game.EntityMixins.InventoryHolder = {
  ...
  dropItem: function(i) {
    ...
    if (this._items[i]) {
      if (this._map) {
        this._map.addItem(this.getX(), this.getY(), this.getZ(), this._items[
          i]);
      }
      this.removeItem(i);
    }
